...
QT_MOC_LITERAL(3, 20, 8), // "firstPos"
QT_MOC_LITERAL(4, 29, 7), // "lastPos"
QT_MOC_LITERAL(5, 37, 16) // "updateSnapPoints"

    },
    "ScalePicker\0picked\0\0firstPos\0lastPos\0"
    "updateSnapPoints"
};
...
void ScalePicker::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->picked((*reinterpret_cast< double(*)>(_a[1])),(*reinterpret_cast< double(*)>(_a[2]))); break;
        case 1: _t->updateSnapPoints(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (ScalePicker::*)(double , double );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ScalePicker::picked)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void ScalePicker::picked(double _t1, double _t2)
{
